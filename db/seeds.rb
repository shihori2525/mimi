...
Member.create!(
  [
    { email: 'olivia@test.com', name: 'Olivia', password: 'password',
      profile_image: File.open("#{Rails.root}/db/fixtures/sample-user1.png") },
    { email: 'james@test.com', name: 'James', password: 'password',
      profile_image: File.open("#{Rails.root}/db/fixtures/sample-user2.png") },
    { email: 'lucas@test.com', name: 'Lucas', password: 'password',
      profile_image: File.open("#{Rails.root}/db/fixtures/sample-user3.png") }
  ]
)
...
Item.create!(
  [
    { name: 'リップスモンスター', brand_id: '1', category_id: '9',
      item_image: File.open("#{Rails.root}/db/fixtures/sample-item1.JPG") },
    { name: 'トリプルラインエキスパート', brand_id: '1', category_id: '5',
      item_image: File.open("#{Rails.root}/db/fixtures/sample-item2.JPG") },
    { name: 'クイックラッシュカーラーズ', brand_id: '2', category_id: '7',
      item_image: File.open("#{Rails.root}/db/fixtures/sample-item3.JPG") },
    { name: 'シルキー＆スフレアイズ', brand_id: '2', category_id: '6',
      item_image: File.open("#{Rails.root}/db/fixtures/sample-item4.JPG") },
    { name: 'グロウル ルミナイザー', brand_id: '3', category_id: '2',
      item_image: File.open("#{Rails.root}/db/fixtures/sample-item5.JPG") },
    { name: 'スキーニリッチシャドウ', brand_id: '3', category_id: '6',
      item_image: File.open("#{Rails.root}/db/fixtures/sample-item6.JPG") }
  ]
)

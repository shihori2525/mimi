...
[
 ...
 {member_id: '1',item_id:'3',brand_id:'2',
  title:'みんなにおすすめしたいです',rate:'5.0',merit:'とにかくカールキープしてくれる',demerit:'落ちない分クレンジングが大変',usability:'滲まず、良い',cost_performance:'最高',pattern:'02',image: File.open("#{Rails.root}/db/fixtures/sample-item2.JPG")},
 {member_id: '1',item_id:'4',brand_id:'2',
  title:'かわいい',rate:'4.5',merit:'グラデしやすい',demerit:'少し粉っぽい',usability:'少し粉っぽい',cost_performance:'良い',pattern:'04',image: File.open("#{Rails.root}/db/fixtures/sample-item3.JPG")},
 {member_id: '1',item_id:'5',brand_id:'3',
  title:'使うのが難しい',rate:'1.0',merit:'キラキラのツヤツヤになれる',demerit:'サイボーグっぽくなる',usability:'少し乾燥する',cost_performance:'普通',pattern:'02',image: File.open("#{Rails.root}/db/fixtures/sample-item4.JPG")},
 {member_id: '1',item_id:'6',brand_id:'3',
  title:'この値段でこのクオリティ!',rate:'5.0',merit:'安いのにしっかり発色してくれる',demerit:'ブルベ向きカラーが少ない',usability:'粉質がよくしっとり',cost_performance:'良い',pattern:'05',other:'是非買ってみてください！',image: File.open("#{Rails.root}/db/fixtures/sample-item5.JPG")},
 {member_id: '2',item_id:'1',brand_id:'1',
  title:'うーん…',rate:'3.0',merit:'ティントじゃないので色素沈着しない',demerit:'普通に落ちる',usability:'やわらかい',cost_performance:'柔らかくすぐ減るのであまりよくない',pattern:'06',other:'話題だったので買いましたが、自分には合わなくて残念です',image: File.open("#{Rails.root}/db/fixtures/sample-item6.JPG")},
